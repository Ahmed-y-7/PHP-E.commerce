            ...
            <div class="container product_data mt-3">
                <div class="row">
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <h4> SA <s class="text-danger"> <?= $product['original_price']; ?> </s></h4>
                            </div>
                            <div class="col-md-6">
                                <h4> SA <span class="text-success fw-bold"> <?= $product['selling_price']; ?> </span></h4>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-4">
                            ...
                            <div class="row mt-3">
                                ...
                                <div class="col-md-6">
                                    <button class="btn btn-primary px-4"> <i class="fa fa-heart me-2"></i>Add to Wishlist</button>
                                </div>
