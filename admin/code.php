...
else if(isset($_POST['update_category_btn']))
{
    ...
    $update_query = "UPDATE categories SET name='$name', slug='$slug', description='$description', meta_title='$meta_title', meta_description='$meta_description', meta_keywords='$meta_keywords', popular='$popular', image='$update_filename' where id='$category_id' ";
...
else if (isset($_POST['add_product_btn']))
{
    ...
    if($name != "" && $slug !="" && $description != "")
    {
        ...
        $product_query_run = mysqli_query($con , $product_query);
                ...
                {
                    redirect("add-products.php", "All Fields mandatory");
                }

}

else if(isset($_GET['update_product_btn']))
{
    ...
    $update_product_query = "UPDATE products SET category_id='#category_id', name='$name',slug='$slug',small_description='$small_description',description='$description',original_price='$original_price',selling_price='$selling_price',qty='$qty',meta_title='$meta_title',meta_description='$meta_description',meta_keywords='$meta_keywords',
