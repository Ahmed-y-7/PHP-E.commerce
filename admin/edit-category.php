                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                <textarea rows="3" name="description" placeholder="Enter Your description" class="form-control"><?= $data['description'] ?> </textarea>
                            </div>
                            <div class="col-md-6">
                                <label for="">Upload Image</label>
                                <input type="file" name="image"class="form-control">
                                <label for="">Current Image</label>
                                <input type="hidden" name="old_image" value="<?= $_data['image'] ?>">
